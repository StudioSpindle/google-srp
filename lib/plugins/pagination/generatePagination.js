...
export default function (response, paginationContainer, nextButtonClassName, previousButtonClassName, searchMetaClassName) {
  ...
  const [paginationSearchMeta] = document.getElementsByClassName(searchMetaClassName);
